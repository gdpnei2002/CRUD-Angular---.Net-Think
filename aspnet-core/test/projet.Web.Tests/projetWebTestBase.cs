...
{
    public abstract class projetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static projetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(projetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<projetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<projetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<projetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<projetDbContext, Task<T>> func)
        {
            T result;
